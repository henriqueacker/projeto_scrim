...
<?php endif;?>
	...
	<!-- TABELA TOP-->
	<h3 class="header center purple-text">TOP</h3>
	<table class="striped">
		<thead>
			<tr>
				<th>NOME</th>
...
if (mysqli_num_rows($resultado) > 0) :
    while ($dados = mysqli_fetch_array($resultado)) :
		...
		<td><?php echo $dados['nick']; ?></td>
				...
				?>
				<td><a href="atualizarpartidatop.php?id=<?php echo $dados['id']; ?>"
			...
			<div id="modal<?php echo $dados['id']; ?>" class="modal">
				...
				<div class="modal-footer">
					<form action="php/delete.php" method="POST">
						...
						<button type="submit" name="btn-deletartop" class="btn red">Sim,
