...
if (isset($_GET['id'])) :
    ...
    $sql = "SELECT * FROM jg WHERE id = '$id'";
...
<form class="col s12" name='f1' id="f1" action="php/update.php"
			method="post" onload="mostrar()">
   ...
   <?php endif;?>
	...
	<!-- TABELA TOP-->
	<h3 class="header center purple-text">JG</h3>
	<table class="striped">
		<thead>
			<tr>
				<th>NOME</th>
...
if (mysqli_num_rows($resultado) > 0) :
    while ($dados = mysqli_fetch_array($resultado)) :
		...
		<td><?php echo $dados['nick']; ?></td>
				...
				?>
				<td><a href="atualizarpartidajg.php?id=<?php echo $dados['id']; ?>"
			...
			<div id="modal<?php echo $dados['id']; ?>" class="modal">
				...
				<div class="modal-footer">
					<form action="php/delete.php" method="POST">
						...
						<button type="submit" name="btn-deletarjg" class="btn red">Sim,
